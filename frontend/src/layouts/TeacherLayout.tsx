...
const navItems = [
  { path: '/teacher/dashboard', labelKey: 'teacher.dashboard', icon: '📊' },
  { path: '/teacher/courses', labelKey: 'teacher.assignedCourses', icon: '📚' },
  { path: '/teacher/students', labelKey: 'teacher.manageStudents', icon: '👥' },
  { path: '/teacher/assignments', labelKey: 'teacher.assignments', icon: '📝' },
  { path: '/teacher/exams', labelKey: 'teacher.exams', icon: '📋' },
  { path: '/teacher/liveclasses', labelKey: 'teacher.liveClasses', icon: '🎥' },
  { path: '/teacher/timetable', labelKey: 'teacher.timetable', icon: '📅' },
  { path: '/teacher/revenue', labelKey: 'teacher.revenue', icon: '💰' },
  { path: '/teacher/messages', labelKey: 'teacher.messages', icon: '💬' },
  { path: '/teacher/notifications', labelKey: 'teacher.notifications', icon: '🔔' },
  { path: '/teacher/profile', labelKey: 'teacher.profile', icon: '👤' },
];
      ...
      <aside className={`fixed inset-y-0 left-0 z-30 w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 transform transition-transform duration-200 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 lg:static lg:inset-auto`}>
        <div className="h-full flex flex-col">
          <div className="p-4 border-b border-gray-200 dark:border-gray-800">
            <Link to="/teacher/dashboard" className="text-xl font-bold text-primary-600">EDUCOURS</Link>
          </div>
