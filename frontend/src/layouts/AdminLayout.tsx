...
const navItems = [
  ...
  { path: '/admin/courses', labelKey: 'admin.manageCourses', icon: '📚' },
  { path: '/admin/teachers', labelKey: 'admin.manageTeachers', icon: '👨‍🏫' },
  { path: '/admin/students', labelKey: 'admin.manageStudents', icon: '👥' },
  { path: '/admin/transactions', labelKey: 'admin.transactions', icon: '💰' },
  { path: '/admin/tickets', labelKey: 'admin.tickets', icon: '🎫' },
  { path: '/admin/broadcast', labelKey: 'admin.broadcast', icon: '📢' },
      ...
      <aside className={`fixed inset-y-0 left-0 z-30 w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 transform transition-transform duration-200 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 lg:static lg:inset-auto`}>
        <div className="h-full flex flex-col">
          <div className="p-4 border-b border-gray-200 dark:border-gray-800">
            <Link to="/admin/dashboard" className="text-xl font-bold text-primary-600">EDUCOURS</Link>
